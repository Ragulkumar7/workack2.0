...
<body class="bg-gray-100 font-sans leading-normal tracking-normal flex flex-col md:flex-row min-h-screen">
    ...
    <aside id="sidebar" class="w-64 bg-workack-darker text-white shadow-lg flex-col transform -translate-x-full md:translate-x-0 fixed md:relative z-40 h-full transition-transform duration-300 ease-in-out hidden md:flex">
        <div class="h-16 hidden md:flex items-center justify-center border-b border-workack-dark shrink-0">
