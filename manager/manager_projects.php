...
.main-content {
    ...
    transition: margin-left 0.3s ease, width 0.3s ease;
        ...
        .select2-container .select2-selection--single, .select2-container .select2-selection--multiple {
            height: 42px; border: 1px solid var(--border-color); border-radius: 10px; padding: 6px;
        }
        .select2-container--default .select2-selection--multiple .select2-selection__choice {
            background-color: #f1f5f9; border: 1px solid #e2e8f0; color: #1e293b;
        }
        ...
        .btn-load-more { 
            ...
            padding: 10px 24px; border-radius: 10px; font-weight: 600; cursor: pointer; transition: 0.2s; 
        }
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <div style="position:relative;">
                    <input type="text" id="searchInput" placeholder="Search Projects" style="padding: 10px 36px 10px 14px; border:1px solid var(--border-color); border-radius:10px; font-size:0.875rem; transition: 0.2s; outline:none;" onkeyup="applyFilters()">
            ...
            <div class="modal-body">
                <form id="projectForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="team_members[]" class="form-control select2-modal" multiple="multiple" style="width:100%">
                            <?php foreach($users as $user): ?>
                                <option value="<?= $user['id'] ?>"><?= htmlspecialchars($user['name'] ?: $user['username']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div style="text-align:right; margin-top:20px;">
                         <button type="button" class="btn btn-white" onclick="closeModal()" style="display:inline-block;">Cancel</button>
                         <button type="submit" class="btn btn-primary" style="display:inline-block;">Save Project</button>
                    </div>
                </form>
            </div>
        </div>
