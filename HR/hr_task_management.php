...
<head>
    ...
    <style>
        ...
        /* Adjusted margin-left to remove the gap based on your uploaded image */
        .main-wrapper { 
            padding: 30px;
            margin-left: 100px; 
            min-height: 100vh;
        ...
        .btn-save { background: var(--primary-teal); color: white; padding: 11px 22px; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; transition: 0.2s; }
        .btn-save:hover { background: #004d4d; }
        ...
        .action-btn:hover { color: var(--primary-teal); }
