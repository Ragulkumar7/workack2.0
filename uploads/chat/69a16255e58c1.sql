...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2026 at 10:30 AM
...
(21, 15, NULL, '2026-02-20 10:21:25', '2026-02-20 10:21:53', 0.01, 'Late', '2026-02-20', NULL),
(22, 11, NULL, '2026-02-20 11:44:02', NULL, 0.00, 'On Time', '2026-02-20', NULL);
...
(25, 21, '2026-02-20 10:21:41', NULL);
...
CREATE TABLE `call_requests` (
  ...
  `status` enum('ringing','answered','declined','ended') DEFAULT 'ringing',
  `created_at` timestamp NULL DEFAULT current_timestamp()
...
(12, 22, NULL, NULL, NULL, 'Medical', '2026-02-20', '2026-02-21', 2, 'emergency ', 'Approved', 'Pending', 'Pending', 'Approved', NULL, '2026-02-19 09:37:36'),
...
(23, 19, NULL, NULL, 16, 'Annual', '2026-02-21', '2026-02-23', 3, 'Family emergency ', 'Approved', 'Pending', 'Approved', 'Pending', NULL, '2026-02-20 05:14:20'),
(24, 22, NULL, 19, 16, 'Medical', '2026-02-21', '2026-02-21', 1, 'Medical', 'Approved', 'Pending', 'Pending', 'Approved', NULL, '2026-02-20 05:22:13');
...
INSERT INTO `shift_swap_requests` (`id`, `user_id`, `request_date`, `current_shift`, `requested_shift`, `reason`, `status`, `processed_by`, `created_at`, `tl_approval`, `manager_approval`, `hr_approval`, `tl_id`, `manager_id`, `hr_id`) VALUES
(1, 22, '2026-02-21', 'Morning (9AM-6PM)', 'Afternoon (2PM-11PM)', 'Personal management ', 'Pending', NULL, '2026-02-20 04:45:14', 'Pending', 'Pending', 'Pending', NULL, NULL, NULL),
(10, 22, '2026-02-21', 'Night (9PM-6AM)', 'Morning (9AM-6PM)', 'Family emergency ', 'Approved', 22, '2026-02-20 05:05:54', 'Approved', 'Pending', 'Pending', 22, NULL, NULL),
(11, 22, '2026-02-21', 'Afternoon (2PM-11PM)', 'Morning (9AM-6PM)', 'family emergency ', 'Pending', NULL, '2026-02-20 05:31:12', 'Approved', 'Approved', 'Pending', 22, 22, NULL);
...
(11, 'Ramesh', 'EMP-HRE012', 'accounts team', 'hrexecutive@gmail.com', NULL, '$2y$10$lz1VCMchhKgmrnXnz1x4XuEjiBTz4GOxrrHqIl9/cBu7/zymJEp/6', 'HR Executive', NULL),
...
(7, 22, 'Brian', NULL, NULL, '2026-02-20 06:20:29', '2026-02-21', '2026-02-22', 'Regular', 'Medical emergency ', 'Approved', 'Manager'),
(10, 22, 'Brian', NULL, NULL, '2026-02-20 06:52:43', '2026-02-23', '2026-02-24', 'Regular', 'Health issues ', 'Approved', 'Team Lead');
...
ALTER TABLE `call_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_conv_status` (`conversation_id`,`status`),
  ADD KEY `idx_created` (`created_at`),
  ADD KEY `idx_conv_caller_status` (`conversation_id`,`caller_id`,`status`),
...
ALTER TABLE `chat_messages`
  ...
  ADD KEY `idx_conv_sender_read` (`conversation_id`,`sender_id`),
  ADD KEY `idx_conv_created` (`conversation_id`,`created_at` DESC);
...
ALTER TABLE `chat_participants`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_user_conv` (`user_id`,`conversation_id`),
  ADD KEY `conversation_id` (`conversation_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_user_conv` (`user_id`,`conversation_id`),
  ADD KEY `idx_conv_joined` (`conversation_id`,`joined_at`);
