...
<body class="bg-slate-100">
    ...
    <main id="mainContent">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold text-slate-800 tracking-tight"><?= $logged_in_role ?> Dashboard</h1>
                <nav class="flex text-sm text-gray-500 mt-2">
                    <ol class="inline-flex items-center space-x-2">
                        ...
                        <li class="flex items-center"><i class="fa-solid fa-chevron-right text-[10px] text-gray-300"></i> <span class="text-teal-600 font-semibold"><?= $logged_in_role ?> Overview</span></li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover-card h-full">
                    <div class="bg-gradient-to-r from-teal-600 to-teal-700 p-8 pb-10 relative">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <span class="inline-block bg-white/20 text-white text-xs px-3 py-1 rounded-full mt-2"><?php echo $employee['department']; ?></span>
                        </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-sm text-slate-800"><?php echo $employee['report_office']; ?></p>
                            </div>
                        </div>

                        <div class="flex items-center justify-between p-3 bg-green-50 rounded-xl mt-4">
                            ...
                            <span class="font-bold text-sm text-slate-800"><?php echo $employee['joined_date']; ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center justify-between gap-8">
                        <div class="space-y-4 flex-1">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-teal-600 font-bold w-16"><?php echo $stats['on_time']; ?></span>
                                <span class="text-gray-600 text-sm">On Time</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full bg-green-500"></div>
                                <span class="text-green-500 font-bold w-16"><?php echo $stats['late']; ?></span>
                                <span class="text-gray-600 text-sm">Late Attendance</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full bg-orange-500"></div>
                                <span class="text-orange-500 font-bold w-16"><?php echo $stats['wfh']; ?></span>
                                <span class="text-gray-600 text-sm">Work From Home</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full bg-red-500"></div>
                                <span class="text-red-500 font-bold w-16"><?php echo $stats['absent']; ?></span>
                                <span class="text-gray-600 text-sm">Absent</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full bg-yellow-500"></div>
                                <span class="text-yellow-500 font-bold w-16"><?php echo $stats['sick']; ?></span>
                        ...
                        <div class="flex-shrink-0 w-44 h-44 relative">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span class="text-2xl font-bold text-slate-800"><?php echo $stats['percentile']; ?>%</span>
                                <span class="text-[10px] text-gray-400 font-medium">Performance</span>
                            </div>
                        </div>
                    </div>
                    <div class="pt-4 mt-4 border-t border-gray-100 text-xs text-gray-500 flex items-center gap-2">
                        <i class="fa-solid fa-check-circle text-teal-600"></i> 
                        Better than <span class="text-slate-800 font-bold"><?php echo $stats['percentile']; ?>%</span> of Employees
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover-card h-full">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        <div class="text-center p-4 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl">
                            ...
                            <p class="font-bold text-xl text-teal-700"><?php echo $leave_summary['total']; ?></p>
                        </div>
                        <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                            <p class="text-gray-500 text-xs font-medium mb-1">Taken</p>
                            <p class="font-bold text-xl text-blue-700"><?php echo $leave_summary['taken']; ?></p>
                        </div>
                        <div class="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
                            <p class="text-gray-500 text-xs font-medium mb-1">Remaining</p>
                            <p class="font-bold text-xl text-green-700"><?php echo $leave_summary['total'] - $leave_summary['taken']; ?></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <button class="w-full bg-gradient-to-r from-teal-600 to-teal-700 text-white py-4 rounded-xl font-bold text-sm uppercase tracking-wider shadow-lg shadow-teal-200 hover:shadow-xl hover:shadow-teal-300 transition-all">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover-card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="text-xs font-semibold text-gray-500 flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-lg hover:bg-slate-200 transition">
                        Ongoing <i class="fa-solid fa-chevron-down text-[10px]"></i>
                    </button>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover-card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="text-xs font-semibold text-gray-500 flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-lg hover:bg-slate-200 transition">
                        All Tasks <i class="fa-solid fa-chevron-down text-[10px]"></i>
                    </button>
                </div>
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-slate-50 transition-colors hover:border-teal-200">
                        ...
                        <span class="text-[10px] font-bold px-3 py-1 rounded-full <?php echo $task['color']; ?>">
        ...
        <div class="grid grid-cols-12 gap-6 mb-6">
            ...
            <div class="col-span-12 lg:col-span-7 bg-white rounded-2xl shadow-sm border border-gray-100 p-7 hover-card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="border rounded-lg px-3 py-1.5 text-xs text-gray-500 hover:bg-gray-50 flex items-center gap-1">
                        <i class="fa-regular fa-calendar"></i> 2026
                    </button>
                </div>
